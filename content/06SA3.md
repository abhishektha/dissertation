...
A flat pattern of the last was generated by placing masking tape over the last and cutting along seam lines as shown in Fig [XX] [@Motawi2020]. 
...
Patterns for the upper and toe box expected to interface with the pattern for the sole are extended by 1 cm to provide a seam to attach to the sole.
...
The seam from the attachment of the pressure bladder's upper and sole patterns is sewn to the sole as shown in [Fig TBD]. 
