...
\subfloat[A]{\includegraphics[width=0.5\textwidth,height=\textheight]{../fig/SA1/S3C0T1R_Pitch.png}\label{fig:SA1-PitchRaw}}
\subfloat[B]{\includegraphics[width=0.5\textwidth,height=\textheight]{../fig/SA1/S3C0T1R_Pitch_Smooth.png}\label{fig:SA1-PitchFilt}}
