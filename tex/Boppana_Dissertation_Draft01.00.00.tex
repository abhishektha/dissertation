...
%DIF DEL Boppana_ComprehensiveExam-Final.tex   Thu Jan  6 08:42:06 2022
%DIF ADD Boppana_ComprehensiveExam.tex         Tue Feb  8 00:39:19 2022
...
\DIFdelendFL \DIFaddbeginFL \caption[{Zoomed-in view of one example step's foot-flat phase showing ``negative'' {[}A{]} and ``positive'' heel-off lag {[}B{]}. The shaded regions represent the detected foot-flat regions for the operator (blue) and spacesuit(red); an increase in vertical acceleration for the shank IMU (blue) prior to the SLL IMU (red) is ``positive'' heel-off lag, suggesting heel-lift {[}B{]}, and vice-versa {[}A{]}.}]{\DIFaddendFL Zoomed-in view of one example step's foot-flat phase showing ``negative'' {[}A{]} and ``positive'' heel-off lag {[}B{]}. The shaded regions represent the detected foot-flat regions for the operator (blue) and spacesuit(red); an increase in vertical acceleration for the shank IMU (blue) prior to the SLL IMU (red) is ``positive'' heel-off lag, suggesting heel-lift {[}B{]}, and vice-versa {[}A{]}.}
...
A flat pattern of the last was generated by placing masking tape over the last and cutting along seam lines as shown in Fig }{[}\DIFadd{XX}{]} \DIFadd{\mbox{%DIFAUXCMD
...
}\DIFdelend \DIFaddbegin \DIFadd{Sports Product Design Program to fit the last used for the prototype spacesuit boot design.
...
\DIFadd{Patterns for the upper and toe box expected to interface with the pattern for the sole are extended by 1 cm to provide a seam to attach to the sole.
...
The seam from the attachment of the pressure bladder's upper and sole patterns is sewn to the sole as shown in }{[}\DIFadd{Fig TBD}{]}\DIFadd{.
