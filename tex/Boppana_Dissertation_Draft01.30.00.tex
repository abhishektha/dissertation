...
\reader{Dr.~Daniel Feeney}		%  2nd person to sign thesis

\readerThree{Dr.~Rodger Kram}		%  3rd person to sign thesis

\readerFour{Dr.~Torin Clark}		%  4th person to sign thesis

\readerFive{Dr.~David Klaus}		%  5th person to sign thesis
...
\abstract{  \OnePageChapter	% because it is very short
 ...
 Results from quantitative measurements and surveys found the novel spacesuit boot to have improved heel performance and comfort compared to the classic spacesuit boot, and improved heel performance compared to the work boot in an unlaced configuration.
...
\caption[{Spacesuit design and fit factors link to increased injury risk}]{Overview of how deficiencies in spacesuit design and fit can lead to increased injury risk}
\label{fig:B-fitflow}
\end{figure}
}
...
\caption[{Knee and foot trauma identified in the MK III 10 km walkback evaluation}]{Knee (left) and foot (right) trauma identified in the MK III following 10 km walkback evaluation. From Norcross et al.~2009}
\label{fig:B-Trauma}
\end{figure}
}
...
\caption[{Heel-lift occurring during heel-off, as subjectively reported in the MK III}]{Heel-lift occurring during heel-off, as subjectively reported in the MK III. The poor fit and indexing in the boot and lower torso allows the heel to lift inside the boot during heel-off}
\label{fig:B-HeelLift}
\end{figure}
}
...
\includegraphics{../fig/SA1/IMUPlacement.png}\{\#fig:SA1-Loc width=``70\%'' short-caption= ``Location of IMUs and padding''\}
...
The proposed design framework will link traditional linear foot measurements described in the previous section and the dynamic foot shape model (Chapter sec.~\ref{sec:SA2}) to specific footwear design variables, allowing for the design of a spacesuit boot with an emphasis on improving fit, comfort, and mobility.
...
Lacing or other closure mechanisms can assist the upper in conforming to and capturing the foot (Chapter sec.~\ref{sec:SA2}).
...
The coupons were then tested on an Instron machine using an ASTM D5034-19 fabric tensile test method.
...
\includegraphics{../fig/SA3/BladderSeam.png}\{\#fig:SA3-seam width=``40\% short-caption=''Pressure bladder construction technique"\}
...
\caption[{Neoprene layer patterning}]{Patterning of the base neoprene layer (top) which results in a much smaller opening (bottom, annotated) for the wearer's calf to enter through.}
...
\caption[{Marker locations for the four test boot conditions.}]{Marker locations for the novel spacesuit boot (A), work boot (B), and a subject's left shoe (C). The novel spacesuit boot and left shoe use black Duck tape for markers on their sole. The work boot uses a silver reflective tape for its markers. The Kinovea software's annotations are shown on each of the image: Marker 1 is tracked to provide heel rise magnitude, and the orange line is used to calibrate the coordinate system.}
...
Then, Python's \texttt{scipy.signal.find\_peaks} algorithm was used to identify peaks with a prominence of at least 0.5 V and a width of 5 samples.
...
Every subject was able to reach a boot internal pressure of 2.5 psi for both pressurized boots.
...
Figure \ref{fig:SA4-exSet} shows an example FSR response and heel-rise measurement from a subject's heel-rise set.

\hypertarget{fig:SA4-exSet}{%
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=\textheight]{../fig/SA4/exSet.png}
\caption[{FSR and heel-rise data trace}]{Example FSR and heel-rise data trace from a heel-rise set. Detected peaks and heel-off times are shown with the vertical lines}
\label{fig:SA4-exSet}
\end{figure}
}
...
\includegraphics{../fig/SA4/FSR_HO.png}\{\#fig:SA4-FSRH0 width=``80\%'' short-caption="FSR voltage at heel-off posterior estimate\}
...
The spacesuit boot has demonstrated specific problems relating to poor fit, such as heel-lift and contact injuries, and thus was the focus of this thesis.
...
In addition, findings from this study suggest that use of measurement techniques which can directly measure the heel contact in the boot.
...
As shown in this thesis' first specific aim, the fit and comfort of one spacesuit component may affect other components it connects to.
...
However, future work should explore whether it is feasible to then incorporate requirements for protection and life support into a spacesuit which is designed around mobility.
