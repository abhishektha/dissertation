...
\readerThree{$readerThree$}		%  3rd person to sign thesis

\readerFour{$readerFour$}		%  4th person to sign thesis

\readerFive{$readerFive$}		%  5th person to sign thesis
...
$if(IRBprotocol)$
\IRBprotocol{$IRBprotocol$}	% optional!
$endif$
